package com.sourcey.materiallogindemo.thirdPage.Question;
...
public class question_dialog2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ask_question.setText("有遇到甚麼快樂的事情嗎?");

        if (buffer.getAlert_question_voice().equals("ON")) {
            String path = "http://140.116.82.102:8080/app/question/question2.wav";
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0) { // 按下的如果是BACK，同时没有重复
            ...
            Intent intent = new Intent(getApplicationContext(), question_dialog2.class);
    ...
    private void setDialogInitial() {
        ...
        writebuilder = new AlertDialog.Builder(question_dialog2.this);
        ...
        emotionbuilder = new AlertDialog.Builder(question_dialog2.this);
    ...
    private View.OnClickListener NoQuestionListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            Intent intent = new Intent(question_dialog2.this, MainActivity.class);
            startActivity(intent);
        }
    };
    ...
    private View.OnClickListener videolist = new View.OnClickListener() {
        public void onClick(View v) {
            videobuilder = new AlertDialog.Builder(question_dialog2.this);
            ...
            video_Recorder.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (getPackageManager().hasSystemFeature(PackageManager.FEATURE_CAMERA_FRONT)) {
                        ...
                        Toast.makeText(question_dialog2.this, "找不到裝置", Toast.LENGTH_LONG).show();
                    }
                }
            });
    ...
    private void VideoEmotionButton() {
        ...
        VideoEmotionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                videoEmotionbuilder = new AlertDialog.Builder(question_dialog2.this);
    ...
    private void micDialog() {
        ...
        imageMicButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                micbuilder = new AlertDialog.Builder(question_dialog2.this);
    ...
    private Runnable sql = new Runnable() {
        public void run() {
            //set Data to SQL
            SQL sql1 = new SQL();
            sql1.InsertNewData_new(buffer.getAccount(), threadtime, threadcontent, threademotion, icontype);
        }
    };
    ...
    private void next_question() {
        Intent intent = new Intent(question_dialog2.this, question_dialog3.class);
        startActivity(intent);
    }
}