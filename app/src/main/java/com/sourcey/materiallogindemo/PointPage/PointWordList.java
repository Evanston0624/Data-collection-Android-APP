...
public class PointWordList extends RecyclerView.Adapter<PointWordList.WordViewHolder>  {
    ...
    public PointWordList(Context context, LinkedList<LinkedList<String>> wordList) {
    ...
    class WordViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        final PointWordList mAdapter;

        public WordViewHolder(View itemView, PointWordList adapter) {
            super(itemView);
        ...
        public void onClick(View view) {
            ...
            Intent intent = new Intent(mContext, PointWord.class);
