...
import com.sourcey.materiallogindemo.twicePage.internal.Renderer;
...
public class KLineChart extends View {
    ...
    public void notifyDataSetChanged(boolean invalidate) {
        ...
        renderer.setData(mData, marrayList);
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        switch (action) {
            ...
            case MotionEventCompat.ACTION_POINTER_DOWN: {
                ...
                mode = 1;
                renderer.set_currentmatrix();
                startDis = e.getX(1) - e.getX(0);
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (mode == 1) {
                    if (e.getPointerCount() >= 2) {
                        endDis = e.getX(1) - e.getX(0);
                        scale = endDis / startDis;
                        //midX = (e.getX(1) + e.getX(0)) / 2;
                        renderer.zoomIn(scale, midX, e.getY(1));
                    } else {
                        mode = 0;
                    }
                }
